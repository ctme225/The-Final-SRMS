                    ...
                    <div class="mx-auto text-center">
                        ...
                        <h1 class="mx-auto my-0 text-uppercase">Resource Management</h1>
                            <div class="row">
                                ...
                                <div class = "col-sm">
                                    <div class="col-sm">
                                        <a type="button" id = "locat" href = res/${mylocationmodel.locId} class="btn btn-success btn-lg btn-block"><i class = "fa fa-clipboard" style = "font-size: 48px; text-shadow:2px 2px 4px #000000;"></i>   Manage Resources</a>
                                    </div>
                                </div>
                            </div>
                            <div class = "row">
