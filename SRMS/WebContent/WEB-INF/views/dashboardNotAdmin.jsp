                    ...
                    <div class="mx-auto text-center">
                        ...
                        <h1 class="mx-auto my-0 text-uppercase">Resource Management</h1>
                            <div class="row">
                                <div class="col-sm">
                                    <div class="col-sm">
                                        <a type="button" id = "rsvtn" href = reserve class="btn btn-secondary btn-lg btn-block"><i class = "fa fa-calendar-plus" style = "font-size: 48px; text-shadow:2px 2px 4px #000000;"></i> View Resources</a>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class = "col-sm">
                                        <a type="button" id="util" href = util class="btn btn-primary btn-lg btn-block"><i class = "fa fa-chart-bar" style = "font-size: 48px; text-shadow:2px 2px 4px #000000;"></i> Utilization Reports</a>
                                    </div>
                                </div>
                                <div class = "col-sm">
                                    <div class = "col-sm">
